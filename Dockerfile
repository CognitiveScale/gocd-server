...
&& rm -r /tmp/*
Add github-oauth-login-1.3.jar /opt/go-server/plugins/external/
...
RUN LAYER=plugins \
  ...
  && wget https://github.com/ashwanthkumar/gocd-slack-build-notifier/releases/download/v1.3.0/gocd-slack-notifier-1.3.0.jar \
...
#  && wget https://github.com/matt-richardson/gocd-websocket-notifier/releases/download/0.4.0/gocd-websocket-notifier-0.4.jar
